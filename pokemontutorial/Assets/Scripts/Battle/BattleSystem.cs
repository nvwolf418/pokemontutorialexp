...
public class BattleSystem : MonoBehaviour
{
    ...
    public IEnumerator SetUpBattle()
    {
        ...
        else
        {
            ...
            //send out firt pokemon of trainer
    ...
    bool CheckIfMoveHits(Move move, Pokemon source, Pokemon target)
    {
        ...
        float moveAccuracy = move.Base.Accuaracy;
    ...
    void HandlePartyScreenSelection()
    {
        ...
        else if(Input.GetKey(KeyCode.X))
        {
            ...
            {
                partyScreen.SetMessageText("You have to show a pokemon to continue!");
                return;
            }
    ...
    IEnumerator TryToEscape()
    {
        ...
        else
        {
            ...
            {
                yield return dialogBox.TypeDialog($"Escape attempt {escapeAttempts} failed!");
                state = BattleState.RunningTurn;
            }
        }
    }
